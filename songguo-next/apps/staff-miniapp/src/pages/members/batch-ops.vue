...
const actions = computed<BatchAction[]>(() => [
  {
    ...
    reason: "需要会员查看权限",
    action: () => uni.navigateTo({ url: "/pages/members/filter" }),
  },
  {
    id: "import",
    title: "文本批量导入潜客",
    ...
    reason: "需要批量导入或创建权限",
    action: () => uni.navigateTo({ url: "/pages/members/batch-import" }),
  },
  {
    id: "link-requests",
    title: "档案关联审核",
    ...
    enabled: canFilter.value,
    reason: "需要会员查看权限",
    action: () => uni.navigateTo({ url: "/pages/members/link-requests" }),
  },
  {
    id: "archived-cards",
    title: "归档会员卡",
    ...
    enabled: canFilter.value,
    reason: "需要会员查看权限",
    action: () => uni.navigateTo({ url: "/pages/members/archived-cards/index" }),
  },
  {
    id: "batch-issue",
    title: "批量发卡",
  ...
  },
  {
    ...
    reason: "需要会员卡余额调整权限",
    action: () => uni.navigateTo({ url: "/pages/members/batch-workbench?action=balance" }),
  },
  {
    id: "batch-validity",
    title: "批量延期",
    ...
    reason: "需要会员卡延期权限",
    action: () => uni.navigateTo({ url: "/pages/members/batch-workbench?action=validity" }),
  },
  {
    id: "batch-freeze",
    title: "批量停卡/复卡",
    ...
    reason: "需要会员卡冻结权限",
    action: () => uni.navigateTo({ url: "/pages/members/batch-workbench?action=freeze" }),
  },
]);
