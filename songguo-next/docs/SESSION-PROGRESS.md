...
| `songguo-next/docs/END-OF-DAY-FINAL.md` | Truth audit + honest % |
| `songguo-next/docs/stage-acceptance-matrix.md` | 5 new PARTIAL rows; counts 4/0 |
| `songguo-next/docs/DEFERRED-REGISTRY.md` | WeChat Pay checkout wiring plan |
