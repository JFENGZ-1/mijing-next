...
function openBusinessRoles() {
  ...
  uni.navigateTo({ url: `/subpackages/settings/business-roles/assignments?staffId=${staffId.value}` });
}
...
function openRoleEditor() {
  permissionVisible.value = false;
  uni.navigateTo({ url: "/subpackages/settings/roles/edit" });
}
...
onShareAppMessage(() => ({
  ...
  path: `/subpackages/misc/invite/accept?sign=${member.value?.inviteSign || ""}`,
}));
