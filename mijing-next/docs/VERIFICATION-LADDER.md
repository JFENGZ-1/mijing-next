...
| OpenAPI | `mijing-next/docs/openapi.yaml` |
...
- 实现交接：`mijing-next/docs/AI-HANDOFF.md`
- 对抗式执行计划：`mijing-next/docs/ADVERSARIAL-EXECUTION-PLAN.md`
- 审计一页摘要：`mijing-next/docs/AUDIT-SYNTHESIS.md`
