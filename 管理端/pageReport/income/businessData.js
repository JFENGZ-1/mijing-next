(global.webpackJsonp = global.webpackJsonp || []).push([
      ...
      var o = {
        ...
        i = function () {
          ...
          var t = (this._self._c, this.list && this.list.length > 0),
            n = t ? null : this.imgsrc("/static/imgs/nodata.png"),
            e = this.list && 0 != this.list.length;
          this.$mp.data = Object.assign({}, { $root: { g0: t, m0: n, g1: e } });
        },
        u = [];
    },
    "4f22": function (t, n, e) {
            ...
            (e("8f59"),
            {
              ...
              methods: {
                headleDelete: function (n) {
                  t.navigateTo({
                    url:
                      "/pageReport/income/businessDataDetail?item=" +
                      JSON.stringify(n),
                  });
                },
                getList: function () {
                  var t = this,
                    n = this.nowYear,
                    e = this.nowStrmonth;
                  (0, u.profitMonthList)({ year: n, month: e }).then(
                    function (n) {
                      (t.data = n.data),
              ...
              onLoad: function (t) {
                (this.nowStrmonth = t.strmonth),
                  (this.nowYear = t.year),
                  (this.title =
                    this.nowYear + "-" + this.nowStrmonth + "  收款统计"),
                  this.getList();
              },
            });
        n.default = a;
  ...
  [["d885", "common/runtime", "common/vendor"]],
]);
