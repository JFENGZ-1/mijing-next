(global.webpackJsonp = global.webpackJsonp || []).push([
    ...
    8728: function (t, e, n) {
      ...
      var i = {
        ...
        props: {
          ...
          bounces: { type: Boolean, default: !0 },
        },
        data: function () {
          return {
            visibleSync: !1,
        ...
        computed: {
          style: function () {
            ...
            return (
              this.duration &&
                (t.transition = "all ".concat(this.duration / 1e3, "s linear")),
              t
            );
          },
          centerStyle: function () {
            ...
            return (
              ...
              (t.height = this.height
                ...
                : "auto"),
              (t.zIndex = this.uZindex),
              (t.marginTop = "-".concat(this.$u.addUnit(this.negativeTop))),
              this.borderRadius &&
                ((t.borderRadius = "".concat(this.borderRadius, "rpx")),
                (t.overflow = "hidden")),
              t
            );
          },
        ...
        methods: {
          ...
          maskClick: function () {
            this.$emit("maskClick"), this.close();
          },
          close: function () {
        ...
        o = function () {
          var t = this,
            e =
              ...
              t._self._c,
              t.visibleSync
                ? t.__get_style([t.customStyle, { zIndex: t.uZindex - 1 }])
                : null),
            n = t.visibleSync ? t.__get_style([t.style]) : null,
            i =
              t.visibleSync && "center" == t.mode
                ? t.__get_style([t.centerStyle])
                : null,
            o =
              t.visibleSync && "center" != t.mode && t.closeable
                ? t.imgsrc("/static/imgs/modal_close.png")
                : null;
          t.$mp.data = Object.assign(
            {},
            { $root: { s0: e, s1: n, s2: i, m0: o } },
          );
        },
        u = [];
    },
  ...
  (global.webpackJsonp = global.webpackJsonp || []).push([
    ...
    {
      "uview-ui/components/u-popup/u-popup-create-component": function (
        t,
        e,
        n,
      ) {
        n("df3c").createComponent(n("40dc"));
      },
    },
    [["uview-ui/components/u-popup/u-popup-create-component"]],
  ]);
