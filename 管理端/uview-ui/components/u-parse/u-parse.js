(global.webpackJsonp = global.webpackJsonp || []).push([
  ["uview-ui/components/u-parse/u-parse"],
  {
    "269f": function (t, e, n) {
      "use strict";
      n.r(e);
    ...
    4546: function (t, e, n) {
      ...
      (function (t, i) {
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.default = void 0);
        var o = {},
          s = t.getFileSystemManager ? t.getFileSystemManager() : null,
          a = n("7fa2"),
          r = {
            name: "parser",
            data: function () {
            ...
            components: {
              trees: function () {
                n.e("uview-ui/components/u-parse/libs/trees")
                  .then(
                    function () {
                      return resolve(n("0ab2"));
                    }.bind(null, n),
                  )
                  .catch(n.oe);
              },
                ...
                (this.imgList.setItem = function (t, e) {
                  ...
                  if (null != t && e) {
                    if (0 == e.indexOf("http") && this.includes(e)) {
                      for (
                        var o, a = e.split("://")[0], r = a.length;
                        (o = e[r]) &&
                        ("/" != o || "/" == e[r - 1] || "/" == e[r + 1]);
                        r++
                      )
                        a += Math.random() > 0.5 ? o.toUpperCase() : o;
                      return (a += e.substr(r)), (this[t] = a);
                    }
                    if (((this[t] = e), e.includes("data:image"))) {
                      var c,
                        l = e.match(/data:image\/(\S+?);(\S+?),(.+)/);
                      if (!l) return;
                      (c = ""
            ...
            beforeDestroy: function () {
              this.imgList.each(function (e) {
                e &&
                  e.includes(t.env.USER_DATA_PATH) &&
                  s &&
                  s.unlink({ filePath: e });
              }),
              ...
              setContent: function (e, n) {
                ...
                this.$emit("parse", i),
                  ...
                  i.length &&
                    i.title &&
                    this.autosetTitle &&
                    t.setNavigationBarTitle({ title: i.title }),
                    ...
                    t.createSelectorQuery()
                      ...
                      .exec(function (t) {
                        t &&
                          ((s.rect = t[0]),
                          s.rect.height == r &&
                            (s.$emit("ready", s.rect), clearInterval(s._timer)),
                          (r = s.rect.height));
                      });
                  }, 350)),
                ...
                for (
                  ...
                  if ("text" == t.type)
                    ...
                    var o =
                      ...
                      "tr" == t.name ||
                      "li" == t.name ||
                      ("h" == t.name[0] && t.name[1] > "0" && t.name[1] < "7");
                    o && n && "\n" != n[n.length - 1] && (n += "\n"),
                ...
                this._in
                  ...
                  i.exec(function (i) {
                    ...
                    n._in
                      ...
                      : t.pageScrollTo({ scrollTop: o, duration: 300 }),
                      e.success && e.success();
                  });
              },
  ...
  (global.webpackJsonp = global.webpackJsonp || []).push([
    ...
    {
      "uview-ui/components/u-parse/u-parse-create-component": function (
        t,
        e,
        n,
      ) {
        n("df3c").createComponent(n("eb32"));
      },
    },
    [["uview-ui/components/u-parse/u-parse-create-component"]],
  ]);
