(global.webpackJsonp = global.webpackJsonp || []).push([
  ["node-modules/uview-ui/components/u-count-down/u-count-down"],
  {
    1929: function (t, e, o) {
      o.r(e);
      var n = o("49f6"),
          ...
          var t = this,
            e =
              ...
              t.showDays && (t.hideZeroDay || (!t.hideZeroDay && "00" != t.d))
                ? t.__get_style([t.itemStyle])
                : null),
            o =
              t.showDays && (t.hideZeroDay || (!t.hideZeroDay && "00" != t.d))
                ? t.__get_style([t.letterStyle])
                : null,
            n = t.showHours ? t.__get_style([t.itemStyle]) : null,
            i = t.showMinutes ? t.__get_style([t.itemStyle]) : null,
            r = t.showSeconds ? t.__get_style([t.itemStyle]) : null;
          t.$mp.data = Object.assign(
            {},
            { $root: { s0: e, s1: o, s2: n, s3: i, s4: r } },
          );
        },
        i = [];
    },
    ...
    "49f6": function (t, e, o) {
      ...
      var n = {
        ...
        props: {
          ...
          separatorSize: { type: [Number, String], default: 30 },
          ...
          showHours: { type: Boolean, default: !0 },
          showDays: { type: Boolean, default: !0 },
          hideZeroDay: { type: Boolean, default: !1 },
        },
        watch: {
        ...
        computed: {
          itemStyle: function () {
            ...
            return (
              this.height &&
                ((t.height = this.height + "rpx"),
                (t.width = this.height + "rpx")),
              this.showBorder &&
                ((t.borderStyle = "solid"),
          ...
          letterStyle: function () {
            var t = {};
            return (
              this.fontSize && (t.fontSize = this.fontSize + "rpx"),
        ...
        methods: {
            ...
            this.clearTimer(),
              this.timestamp <= 0 ||
                ...
                (this.timer = setInterval(function () {
                  if (
                    (t.seconds--, t.$emit("change", t.seconds), t.seconds < 0)
                  )
                    return t.end();
          ...
          formatTime: function (t) {
            ...
            var r = null;
            (r = this.showDays ? e : Math.floor(t / 3600)),
              (n = Math.floor(t / 60) - 60 * e - 24 * o * 60),
              (i = Math.floor(t) - 24 * o * 60 * 60 - 60 * e * 60 - 60 * n),
              (r = r < 10 ? "0" + r : r),
              (n = n < 10 ? "0" + n : n),
              (i = i < 10 ? "0" + i : i),
              (o = o < 10 ? "0" + o : o),
