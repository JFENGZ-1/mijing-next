      ...
      var i = {
        ...
        watch: {
          src: {
            ...
            handler: function (e) {
              e
                ? ((this.isError = !1), (this.loading = !0))
                : ((this.isError = !0), (this.loading = !1));
            },
          },
        },
        computed: {
          wrapStyle: function () {
            var e = {};
            return (
              (e.width = this.$u.addUnit(this.width)),
              (e.height = this.$u.addUnit(this.height)),
              (e.borderRadius =
                "circle" == this.shape
                  ? "50%"
                  : this.$u.addUnit(this.borderRadius)),
              (e.overflow = this.borderRadius > 0 ? "hidden" : "visible"),
              this.fade &&
                ((e.opacity = this.opacity),
                (e.transition = "opacity ".concat(
                  Number(this.durationTime) / 1e3,
                  "s ease-in-out",
                ))),
              e
            );
        ...
        n = function () {
          var e = this,
            t =
              (e.$createElement,
              e._self._c,
              e.__get_style([e.wrapStyle, e.backgroundStyle])),
            o =
              e.isError || "circle" == e.shape
                ? null
                : e.$u.addUnit(e.borderRadius),
            i =
              e.showLoading && e.loading && "circle" != e.shape
                ? e.$u.addUnit(e.borderRadius)
                : null,
            n =
              e.showError && e.isError && !e.loading && "circle" != e.shape
                ? e.$u.addUnit(e.borderRadius)
                : null;
          e.$mp.data = Object.assign(
            {},
            { $root: { s0: t, g0: o, g1: i, g2: n } },
          );
        },
        r = [];
    },
