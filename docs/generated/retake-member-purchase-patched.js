...
run('automation_evaluate', `--project "${memberProject}" --fn-source ${JSON.stringify(readFn('member-purchase-patch-modal.js'))}`);
...
console.log('member patched-modal retake done');
