...
const purchaseOut = run(
  'automation_evaluate',
  `--project "${memberProject}" --fn-source ${JSON.stringify(readFn('member-purchase-api-eval.js'))}`,
);
console.log('api purchase:', purchaseOut);
pause(2);
...
console.log('member success shot done');
