...
console.log(run('automation_evaluate', `--project "${memberProject}" --fn-source ${JSON.stringify(readFn('member-purchase-patch-vendor.js'))}`));
...
console.log('member vendor-patch retake done');
