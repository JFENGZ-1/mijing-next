...
pause(1);
run('automation_viewport_action', `--project "${memberProject}" --action screenshot --wait-seconds 1 --path "${outDir}/member-card-purchase-success.png"`);
console.log('member confirm modal captured');

// skip export section when only fixing member shot
process.exit(0);
